 ...
 *
 * @package   LRB_Hours
 * @author    Jill Forsythe <j.forsythe8@gmail.com>
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2015 Red Academy
 *
 * @wordpress-plugin
 * Plugin Name:       LRB Business Hours Widget
 * Plugin URI:        @TODO
 * Description:       A handy business hours widget for the Le Red Bread bakery.
 * Version:           1.0.0
...
class LRB_Hours extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'lrb-hours';
